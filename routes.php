...
Route::patch('provider/{id}','ProviderController@update');
...
Route::group(['middleware'=>['auth','role:super_admin|admin|hr']], function () {
...
Route::get('all_routes/{id}/delete','RouteController@destroy');
